    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto" >
                <li class="nav-item nav-elem" ><a class="nav-link" href="{{ route('home') }}">Home</a></li>
                <li class="nav-item nav-elem"><a class="nav-link" href="{{ route('tutor-register') }}">Tutor Register</a></li>
